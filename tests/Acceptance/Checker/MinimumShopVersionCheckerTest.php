...
class MinimumShopVersionCheckerTest extends ApplicationTestCase
{
    ...
    public function testReturnViolationWhenProjectHasIssues(): void
    {
        ...
        | # | Message                                                                                                               | Target                                |
        +---+-----------------------------------------------------------------------------------------------------------------------+---------------------------------------+
        | 1 | The package "spryker-feature/agent-assist" version "202203.0" is not supported. Minimum allowed version is "202204.0" | spryker-feature/agent-assist:202203.0 |
        +---+-----------------------------------------------------------------------------------------------------------------------+---------------------------------------+
        | 2 | The package "spryker/availability-gui" version "6.5.9" is not supported. Minimum allowed version is "6.6.0"           | spryker/availability-gui:6.5.9        |
        +---+-----------------------------------------------------------------------------------------------------------------------+---------------------------------------+
